...
export function App() {
  ...
  return (
    <main className="min-h-screen max-w-screen-xl mx-auto flex flex-col items-center">
      <Header title="T-Sender" className="w-full" />
      <div className="flex flex-col items-center justify-center pb-8 pt-2">
        <h1 className="text-2xl sm:text-4xl font-bold bg-gradient-to-r from-orange-400 via-orange-500 to-yellow-400 bg-clip-text text-transparent">
          Token Airdrop
        </h1>
